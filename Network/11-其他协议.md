...
- 而 HTTP 请求可能在每个请求都额外携带状态信息（如：身份认证等）
...
**HLS (HTTP Live Streaming)**，苹果公司出品，参考：[RFC 8216](https://tools.ietf.org/html/rfc8216)
